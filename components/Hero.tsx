  ...
  return (
    <section className="relative">
      <div className="relative overflow-hidden">
        ...
        <div className="pointer-events-none absolute -bottom-12 -right-14 h-52 w-72 sm:bottom-0 sm:right-0 sm:h-64 sm:w-96 md:bottom-2 md:right-4 md:h-80 md:w-[34rem] lg:-bottom-6 lg:-right-10 lg:h-[24rem] lg:w-[36rem] xl:-bottom-8 xl:-right-12 xl:h-[26rem] xl:w-[39rem]">
          <Image
      ...
      <div className="absolute inset-x-0 bottom-0 flex translate-y-1/2 justify-center px-4">
        <div className="w-full max-w-[22rem] rounded-xl bg-[#e5eef2] px-5 py-3 text-center shadow-[0_16px_32px_-18px_rgba(15,23,42,0.55)] sm:max-w-3xl sm:rounded-2xl sm:px-6 sm:py-4 md:max-w-[56rem] md:px-8 lg:max-w-[62rem] lg:px-10">
          <p className="text-[1.55rem] leading-[1.12] text-[var(--color-primary)] sm:text-[1.95rem] md:text-5xl md:leading-none lg:whitespace-nowrap">
