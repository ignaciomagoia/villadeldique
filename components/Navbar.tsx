  ...
  return (
    <header className="sticky top-0 z-50 bg-[var(--color-primary)]/95 shadow-sm backdrop-blur">
      <div className="mx-auto flex w-full max-w-6xl items-center justify-between px-4 py-4 md:px-8">
        ...
        >
          <Logo className="h-[3.6rem] w-[90px] drop-shadow-[0_4px_7px_rgba(0,0,0,0.35)] md:h-[4rem] md:w-[100px] md:drop-shadow-[0_6px_12px_rgba(0,0,0,0.45)] lg:h-[4.9rem] lg:w-[126px]" />
        </Link>
